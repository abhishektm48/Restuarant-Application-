...
const Hero = () =>
{
    return(
        <div>
       <div className="w-full container px-10 md:px-28 py-8 bg-center bg-cover min-h-fit bg-[url('https://images.unsplash.com/photo-1491185841098-9ce20f966624?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1632&q=80')]">
                <nav className="flex items-center">
                    <div className="text-2xl font logo-font cursor-pointer text-white hover:text-orange-600 duration-300">
                        <h1>Easy <span className="text-orange-500 hover:text-white duration-300">Foods</span></h1>
                    </div>
                    ...
                    <i className="fa-solid fa-bars text-orange-600 md:hidden flex-1 text-right hover:text-white duration-300 cursor-pointer" id="toggle-btn"></i>
                </nav>
                <div className="text-white mt-12 md:my-40 max-w-lg">
                    <h1 className="text-4xl md:text-5xl font-semibold">It's all about <span className="text-orange-600">good foods & taste..</span></h1>
